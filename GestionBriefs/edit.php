                        ...
                        <div class="col-md-12">
                                <div class="card card-info">
                                    <div class="card-header">
                                        <h3 class="card-title"> <i class="far fa-check-circle nav-icon"></i> Modifer un brief projet</h3>
                                    </div>
                                                ...
                                                <div class="bs-stepper-content">
                                                    ...
                                                    <div id="description-part" class="content" role="tabpanel"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="titre" name="titre" placeholder="Titre de projet" value="Site web responsive" >
                                                        </div>
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <textarea 
                                                                ...
                                                                Une projet de développement Web
                                                            </textarea>
                                                        </div>
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <textarea 
                                                                ...
                                                                name="travail" 
                                                                rows="4" 
                                                                placeholder="Décrivez le travail à faire ici...">Concevoir et développer un site Web responsive pour le client
                                                            </textarea>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <input type="text" class="form-control new-link-input reference-link" value="Le site Web doit être entièrement responsive" placeholder="Enter les Critères" id="linkInput1">
                                                        ...
                                                        <div class="form-group" id="deliverables-container">
                                                            ...
                                                            <div id="livrables-list">
                                                                <input type="text" class="form-control mb-3" name="deliverable[]" value="Code" placeholder="Nom de livrable" >
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <ul class="list-group linked-items reference-list" id="referenceList">
                                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                                    ...
                                                                    <button type="button" class="btn btn-outline-danger remove-link-btn ml-2">
